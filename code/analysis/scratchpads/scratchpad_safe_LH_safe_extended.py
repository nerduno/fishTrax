...
#these are fish that are pipetted back into shock tank
e_same_first = [
...
#comparisons 
[tv, safe_shock_end] = scipy.stats.ttest_ind(eBaseVelSafe_3b, eEndVelSafe)
...
[tv, safe_shocksafe] =scipy.stats.ttest_ind(eBaseVelSafe_3b, eBaseVelSafeShock_3b)
...
print 'Statistics comparing end velocity to end of shocking velocity (safe, same, shock same):', safe_shock_end, same_shock_end, shock_safe_end
print 'Statistics comparing end velocities (safe to safeshock, safeshock to same):', safe_safeshock, safe_same
...
pylab.plot([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSame_1a), np.mean(eBaseVelSame_1b), np.mean(eBaseSame), np.mean(eEndVelSame), np.mean(eBaseVelSame_2a), np.mean(eBaseVelSame_2b), np.mean(eBaseVelSame_3a), np.mean(eBaseVelSame_3b)],'o-k',lw=3)
yerrSame = (2*scipy.stats.sem(eBaseVelSame_1a), 2*scipy.stats.sem(eBaseVelSame_1b), 2*scipy.stats.sem(eBaseSame), 2*scipy.stats.sem(eEndVelSame), 2*scipy.stats.sem(eBaseVelSame_2a), 2*scipy.stats.sem(eBaseVelSame_2b), 2*scipy.stats.sem(eBaseVelSame_3a), 2*scipy.stats.sem(eBaseVelSame_3b))
pyplot.errorbar([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSame_1a), np.mean(eBaseVelSame_1b), np.mean(eBaseSame), np.mean(eEndVelSame), np.mean(eBaseVelSame_2a), np.mean(eBaseVelSame_2b), np.mean(eBaseVelSame_3a), np.mean(eBaseVelSame_3b)],fmt='ok',yerr=yerrSame, lw=3)
...
pylab.plot([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSafe_1a), np.mean(eBaseVelSafe_1b), np.mean(eBaseSafe), np.mean(eEndVelSafe), np.mean(eBaseVelSafe_2a), np.mean(eBaseVelSafe_2b), np.mean(eBaseVelSafe_3a), np.mean(eBaseVelSafe_3b)],'o-k',lw=3)
yerrSafe = (2*scipy.stats.sem(eBaseVelSafe_1a), 2*scipy.stats.sem(eBaseVelSafe_1b), 2*scipy.stats.sem(eBaseSafe), 2*scipy.stats.sem(eEndVelSafe), 2*scipy.stats.sem(eBaseVelSafe_2a), 2*scipy.stats.sem(eBaseVelSafe_2b), 2*scipy.stats.sem(eBaseVelSafe_3a), 2*scipy.stats.sem(eBaseVelSafe_3b))
pyplot.errorbar([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSafe_1a), np.mean(eBaseVelSafe_1b), np.mean(eBaseSafe), np.mean(eEndVelSafe), np.mean(eBaseVelSafe_2a), np.mean(eBaseVelSafe_2b), np.mean(eBaseVelSafe_3a), np.mean(eBaseVelSafe_3b)],fmt='ok',yerr=yerrSafe, lw=3)
ax.set_xticks((0,1,2,3,4,5,6,7))
ax.set_xticklabels(('baseline\n first 15', 'baseline\n second 15', 'baseline shock', 'last 5 min\n(shock)', 'baseline\n first 15', 'baseline\n second 15', 'baseline\n first 15', 'baseline\n second 15'))
pylab.xlim((-.25,7.5))
pylab.ylim((0,5.5))
...
yerrSafeShock = (2*scipy.stats.sem(eBaseVelSafeShock_1a), 2*scipy.stats.sem(eBaseVelSafeShock_1b), 2*scipy.stats.sem(eBaseSafeShock), 2*scipy.stats.sem(eEndVelSafeShock), 2*scipy.stats.sem(eBaseVelSafeShock_2a), 2*scipy.stats.sem(eBaseVelSafeShock_2b), 2*scipy.stats.sem(eBaseVelSafeShock_3a), 2*scipy.stats.sem(eBaseVelSafeShock_3b))
...
ESafe = ax.plot([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSafe_1a), np.mean(eBaseVelSafe_1b), np.mean(eBaseSafe), np.mean(eEndVelSafe), np.mean(eBaseVelSafe_2a), np.mean(eBaseVelSafe_2b), np.mean(eBaseVelSafe_3a), np.mean(eBaseVelSafe_3b)],'o-b', lw=3, label='Experimental Fish (5V): Safe-Shocking-Shocking-Safe')
pyplot.errorbar([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSafe_1a), np.mean(eBaseVelSafe_1b), np.mean(eBaseSafe), np.mean(eEndVelSafe), np.mean(eBaseVelSafe_2a), np.mean(eBaseVelSafe_2b), np.mean(eBaseVelSafe_3a), np.mean(eBaseVelSafe_3b)],fmt='ob',yerr=yerrSafe, lw=3)
...
ESafeShock = ax.plot([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSafeShock_1a), np.mean(eBaseVelSafeShock_1b), np.mean(eBaseSafeShock), np.mean(eEndVelSafeShock), np.mean(eBaseVelSafeShock_2a), np.mean(eBaseVelSafeShock_2b), np.mean(eBaseVelSafeShock_3a), np.mean(eBaseVelSafeShock_3b)],'o-c',lw=3, label='Experimental Fish (5V): Safe-Shocking-Safe-Shocking')
pyplot.errorbar([0,1,2,3,4,5,6,7],[np.mean(eBaseVelSafeShock_1a), np.mean(eBaseVelSafeShock_1b), np.mean(eBaseSafeShock), np.mean(eEndVelSafeShock), np.mean(eBaseVelSafeShock_2a), np.mean(eBaseVelSafeShock_2b), np.mean(eBaseVelSafeShock_3a), np.mean(eBaseVelSafeShock_3b)],fmt='oc',yerr=yerrSafeShock, lw=3)
